...
//        }
        ...
        String ckURL = properties.getProperty(CanalConstants.CANAL_CK_URL);
        if (!StringUtils.isEmpty(ckURL)) {
            mqProperties.setCkURL(ckURL);
        }
        String ckUsername = properties.getProperty(CanalConstants.CANAL_CK_USERNAME);
        if (!StringUtils.isEmpty(ckUsername)) {
            mqProperties.setCkUsername(ckUsername);
        }
        String ckPassword = properties.getProperty(CanalConstants.CANAL_CK_PASSWORD);
        if (!StringUtils.isEmpty(ckPassword)) {
            mqProperties.setCkPassword(ckPassword);
        }
        String ckClusterName = properties.getProperty(CanalConstants.CANAL_CK_CLUSTER_NAME);
